!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define("TableEditor", [], e)
    : "object" == typeof exports
    ? (exports.TableEditor = e())
    : (t.TableEditor = e());
})(this, function () {
  return (
    (r = {}),
      ...
      [
        function (t, e, n) {
          ...
          t.exports = function (t, e) {
            var n,
              ...
              s = t.global,
              l = t.stat,
              c = s ? u : l ? u[a] || p(a, {}) : (u[a] || {}).prototype;
            if (c)
              for (n in e) {
                if (
                  ((i = e[n]),
                  (r = t.noTargetGet ? (o = f(c, n)) && o.value : c[n]),
                  !g(s ? n : a + (l ? "." : "#") + n, t.forced) && void 0 !== r)
                ) {
                  if (typeof i == typeof r) continue;
                  v(i, r);
                }
                (t.sham || (r && r.sham)) && d(i, "sham", !0), h(c, n, i, t);
              }
          };
        },
        function (t, e) {
        ...
        function (t, e, n) {
          ...
          t.exports = function (t) {
            return (
              o(c, t) ||
                (s && o(u, t) ? (c[t] = u[t]) : (c[t] = f("Symbol." + t))),
              c[t]
            );
          };
        },
        ...
        function (t, e, n) {
          ...
          var r = n(0),
            ...
            m = o("concat");
          r(
            { target: "Array", proto: !0, forced: !l || !m },
            {
              concat: function (t) {
                for (
                  var e,
                  ...
                  if (
                    ...
                    if (((n = d(r.length)), g < a + n)) throw TypeError(b);
                    for (e = 0; e < n; e++, a++) e in r && h(o, a, r[e]);
                  } else {
                    if (g <= a) throw TypeError(b);
                    h(o, a++, r);
                  }
                return (o.length = a), o;
              },
        ...
        function (t, e, n) {
          ...
          function i(t, e) {
            var n = (nt[t] = S(z[V]));
            return (
              K(n, { type: U, tag: t, description: e }),
              f || (n.description = e),
              n
            );
          }
          ...
          function o(t, e) {
            ...
            if (n !== q || !v(nt, r) || v(rt, r)) {
              var i = Q(n, r);
              return (
                !i || !v(nt, r) || (v(n, B) && n[B][r]) || (i.enumerable = !0),
                i
              );
            }
          }
          ...
          var s = n(0),
            ...
            nt = I("symbols"),
            rt = I("op-symbols"),
            it = I("string-to-symbol-registry"),
            ot = I("symbol-to-string-registry"),
            at = I("wks"),
            st = l.QObject,
            lt = !st || !st[V] || !st[V].findChild,
            ct =
              f &&
              p(function () {
                return (
          ...
          d ||
            (L(
              (z = function (t) {
                ...
                var e = arguments.length && void 0 !== t ? String(t) : void 0,
                  ...
                  r = function (t) {
                    this === q && r.call(rt, t),
                      v(this, B) && v(this[B], n) && (this[B][n] = !1),
                      ct(this, n, x(1, t));
                  };
                return (
                  f && lt && ct(q, n, { configurable: !0, set: r }), i(n, e)
                );
              })[V],
              "toString",
              function () {
            ...
            f &&
              ...
              u || L(q, "propertyIsEnumerable", dt, { unsafe: !0 }))),
            s({ global: !0, wrap: !0, forced: !d, sham: !d }, { Symbol: z }),
            F(E(at), function (t) {
              W(t);
            }),
            s(
              { target: U, stat: !0, forced: !d },
              {
                for: function (t) {
                  var e = String(t);
          ...
          t.exports = function (t, e) {
            ...
            return (f[t] =
              ...
              !l(function () {
                if (r && !s) return !0;
                var t = { length: -1 };
                r ? u(t, 1, { enumerable: !0, get: a }) : (t[1] = 1),
                  n.call(t, i, o);
              }));
          };
        },
            ...
            { target: "Array", proto: !0, forced: !s || !l },
            {
              slice: function (t, e) {
                ...
                if (
                  ...
                  return g.call(o, s, l);
                for (
                  r = new (void 0 === n ? Array : n)(b(l - s, 0)), i = 0;
                  s < l;
                  s++, i++
                )
                  s in o && p(r, i, o[s]);
        ...
        function (t, e, n) {
          ...
          (t.exports = function (t, e, n, r) {
            var i = !!r && !!r.unsafe,
              ...
              a = !!r && !!r.noTargetGet;
            "function" == typeof n &&
              ("string" != typeof e || c(n, "name") || l(n, "name", e),
        ...
        function (t, e, n) {
          ...
          !u ||
            "function" != typeof g ||
            ("description" in g.prototype && void 0 === g().description) ||
            ((r = {}),
            v(
              (i = function (t) {
                var e =
            ...
            ((o = i.prototype = g.prototype).constructor = i),
            (a = o.toString),
            (s = "Symbol(test)" == String(g("test"))),
            (l = /^Symbol\((.*)\)[^)]+$/),
            p(o, "description", {
              configurable: !0,
              get: function () {
                var t = h(this) ? this.valueOf() : this,
                  e = a.call(t);
                if (d(r, t)) return "";
                var n = s ? e.slice(7, -1) : e.replace(l, "$1");
                return "" === n ? void 0 : n;
              },
            }),
            ...
            return function (t, e, n, r) {
              for (
                var i,
                  ...
                  u = 0,
                  f = r || E,
                  d = p ? f(t, c) : v ? f(t, 0) : void 0;
                u < c;
                u++
              )
                if ((y || u in s) && ((o = l((i = s[u]), u, a)), h))
                  if (p) d[u] = o;
                  else if (o)
                    switch (h) {
                      case 3:
            ...
            return [
              ...
              function (t) {
                ...
                for (
                  ...
                  var l = String(i[0]);
                  "" === (a[s] = l) && (n.lastIndex = h(r, d(n.lastIndex), o)),
                    s++;
                }
                return 0 === s ? null : a;
              },
            ...
            g = function () {
              ...
              g = o
                ...
                : (((e = f("iframe")).style.display = "none"),
                  ...
                  t.close(),
                  t.F);
              for (var n = l.length; n--; ) delete g[h][l[n]];
              return g();
            };
          (c[v] = !0),
            (t.exports =
              ...
              function (t, e) {
                ...
                return (
                  null !== t
                    ? ((r[h] = a(t)), (n = new r()), (r[h] = null), (n[v] = t))
                    : (n = g()),
                  void 0 === e ? n : s(n, e)
                );
              });
          ...
          r(
            { target: "Object", stat: !0, sham: !i },
            {
              getOwnPropertyDescriptors: function (t) {
                for (
                  var e, n, r = c(t), i = u.f, o = l(r), a = {}, s = 0;
                  o.length > s;
            ...
            return [
              ...
              function (t, e) {
                ...
                for (var l = []; ; ) {
                  ...
                  if ((l.push(c), !s)) break;
                  "" === String(c[0]) &&
                    (r.lastIndex = P(i, j(r.lastIndex), a));
                }
                for (var u, f = "", d = 0, h = 0; h < l.length; h++) {
                  c = l[h];
                  for (
                    var p = String(c[0]),
                      v = L(I(T(c.index), i.length), 0),
                      g = [],
                      b = 1;
                    b < c.length;
                    b++
                  )
                    g.push(void 0 === (u = c[b]) ? u : String(u));
                  var m,
                    y = c.groups,
                    _ = o
                      ? ((m = [p].concat(g, v, i)),
                  ...
                  d <= v && ((f += i.slice(d, v) + _), (d = v + p.length));
                }
                return f + i.slice(d);
              },
            ];
        ...
        function (t, e, n) {
          ...
          function r(t) {
            ...
            if ("string" == typeof c && 2 < c.length)
              if (43 === (e = (c = b(c)).charCodeAt(0)) || 45 === e) {
          ...
          if (a(m, !y(" 0o1") || !y("0b1") || y("+0x1"))) {
            for (
              ...
              l(y, (x = E[O])) && !l(S, x) && g(S, x, v(y, x));
            ((S.prototype = _).constructor = S), s(o, m, S);
          }
        },
        function (t, e, n) {
          function r(n) {
              ...
              return [
                ...
                function (t, e) {
                  ...
                  for (var u = 0, f = 0, d = []; f < i.length; ) {
                    ...
                    if (
                      null === p ||
                      (h = E(x(l.lastIndex + (A ? 0 : f)), i.length)) === u
                    )
                      f = w(i, f, a);
                    else {
                      if ((d.push(i.slice(u, f)), d.length === c)) return d;
                      for (var v = 1; v <= p.length - 1; v++)
                        if ((d.push(p[v]), d.length === c)) return d;
                      f = u = h;
                    }
                  }
        ...
        function (t, e, n) {
          var s = n(5),
            ...
            u = n(7);
          t.exports = function (t, e) {
            for (var n = l(e), r = u.f, i = c.f, o = 0; o < n.length; o++) {
              var a = n[o];
              s(t, a) || r(t, a, i(e, a));
            }
          };
            ...
            if (
              (g &&
                ...
                k !== Object.prototype &&
                  ...
                  (O ||
                    _(l) === k ||
                    (w ? w(l, k) : "function" != typeof l[T] && S(l, T, b)),
                  x(l, f, !0, !0),
                  O && (A[f] = b))),
              i == P &&
                p &&
              ...
              if (
                ((c = { values: s(P), keys: o ? v : s("keys"), entries: s(R) }),
                a)
              )
                for (u in c) (!j && !d && u in h) || E(h, u, c[u]);
              else m({ target: e, proto: !0, forced: j || d }, c);
            return c;
          };
        },
        function (t, e, n) {
            ...
            { target: "Array", proto: !0, forced: l || !c || !u },
            {
              indexOf: function (t, e) {
                return l
                  ...
                  : i(this, t, 1 < arguments.length ? e : void 0);
              },
            }
          );
        },
        ...
        function (t, e, n) {
          ...
          t.exports = r
            ...
            : function (t, e) {
                s(t);
                for (var n, r = l(e), i = r.length, o = 0; o < i; )
                  a.f(t, (n = r[o++]), e[n]);
                return t;
              };
        },
        ...
        function (t, e, n) {
          ...
          t.exports = function (t, e, n) {
            ...
            if (
              ...
              for (i = new u((r = _(c.length))); v < r; v++)
                (l = h ? d(c[v], v) : c[v]), w(i, v, l);
            else
              for (
                s = (a = p.call(c)).next, i = new u();
                !(o = s.call(a)).done;
                v++
              )
                (l = h ? m(a, d, [o.value, v], !0) : o.value), w(i, v, l);
            return (i.length = v), i;
          };
        },
        function (t, e, n) {
          ...
          if (
            ...
            for (
              var S = function (t, e) {
                  ...
                  w
                    ? i && !o && (t = t.source)
                    : t instanceof S && (o && (e = u.call(t)), (t = t.source)),
                    x &&
                      (n = !!e && -1 < e.indexOf("y")) &&
                      (e = e.replace(/y/g, ""));
                  var a = s(w ? new b(t, e) : b(t, e), r ? this : m, S);
            ...
            ((m.constructor = S).prototype = m), d(i, "RegExp", S);
          }
          v("RegExp");
        },
        function (t, e, n) {
        ...
        function (t, e, n) {
          ...
          var r = n(0),
            ...
            o = n(18),
            a = i("splice"),
            s = o("splice", { ACCESSORS: !0, 0: 0, 1: 2 }),
            m = Math.max,
            y = Math.min;
          r(
            { target: "Array", proto: !0, forced: !a || !s },
            {
              splice: function (t, e) {
                ...
                for (i = g(l, r), o = 0; o < r; o++)
                  (a = u + o) in l && b(i, o, l[a]);
                if (n < (i.length = r)) {
                  for (o = u; o < c - r; o++)
                    (s = o + n), (a = o + r) in l ? (l[s] = l[a]) : delete l[s];
                  for (o = c; c - r + n < o; o--) delete l[o - 1];
                } else if (r < n)
                  for (o = c - r; u < o; o--)
                    (s = o + n - 1),
                      (a = o + r - 1) in l ? (l[s] = l[a]) : delete l[s];
        ...
        function (t, e, n) {
          ...
          t.exports =
            ...
            r(function () {
              ...
              ? function (t, e) {
                  for (
                    var n = g(t), r = arguments.length, i = 1, o = p.f, a = v.f;
                    i < r;
          ...
          i(
            ...
            },
            {
              startsWith: function (t, e) {
                var n = String(l(this));
                s(t);
                var r = a(d(1 < arguments.length ? e : void 0, n.length)),
                  i = String(t);
                return f ? f.call(n, i, r) : n.slice(r, r + i.length) === i;
              },
            }
          );
        },
        ...
        function (t, e, n) {
          function r(s) {
            return function (t) {
              for (
                var e, n = u(t), r = c(n), i = r.length, o = 0, a = [];
                o < i;

              )
                (e = r[o++]),
                  (l && !f.call(n, e)) || a.push(s ? [e, n[e]] : n[e]);
              return a;
            };
          }
          var l = n(4),
        ...
        function (t, e, n) {
          ...
          var i,
            ...
            f =
              ...
              (o = document.createElement("div")).addEventListener(
                "Bootstrap",
                function () {
                  return null;
                }
          ...
          var v = {
            ...
            find: function (t, e) {
              ...
              return (n = []).concat.apply(n, h(u.call(r, t)));
            },
            ...
            children: function (t, e) {
              var n,
                r = (n = []).concat.apply(n, h(t.children));
          ...
          function j(t, e) {
            var n = t.element.classList,
              r = O.state.scrolling(e);
            n.contains(r) ? clearTimeout(k[e]) : n.add(r);
          }
          function T(t, e) {
          ...
          var I = (function () {
              function e(t) {
                P(this, e), (this.element = t), (this.handlers = {});
              }
              return (
                L(e, [
                  {
                ...
                L(t, [
                  {
                    ...
                    value: function (e) {
                      ...
                      return (
                        t || ((t = new I(e)), this.eventElements.push(t)), t
                      );
                    },
                  },
                  {
            ...
            !(function (t, e, n) {
              var r = C(n, 6),
                ...
                f =
                  ...
                  arguments[4],
                d = t.element;
              (t.reach[s] = null), d[a] < 1 && (t.reach[s] = "start");
              d[a] > t[i] - t[o] - 1 && (t.reach[s] = "end");
              e &&
                (d.dispatchEvent(D("ps-scroll-".concat(s))),
                e < 0
                  ? d.dispatchEvent(D("ps-scroll-".concat(l)))
                  : 0 < e && d.dispatchEvent(D("ps-scroll-".concat(c))),
                u &&
                  (function (t, e) {
                    j(t, e), T(t, e);
                  })(t, s));
              t.reach[s] &&
                (e || f) &&
                d.dispatchEvent(
                  D("ps-".concat(s, "-reach-").concat(t.reach[s]))
                );
            })(t, n, r, i, o);
          }
          function W(t) {
            ...
            N = function (t) {
              ...
              (t.containerWidth = Math.floor(r.width)),
                ...
                e.contains(t.scrollbarXRail) ||
                  (E(e, A.element.rail("x")).forEach(S),
                  e.appendChild(t.scrollbarXRail)),
                e.contains(t.scrollbarYRail) ||
                  (E(e, A.element.rail("y")).forEach(S),
                ...
                t.containerWidth + t.settings.scrollXMarginOffset <
                  ...
                  ? ((t.scrollbarXActive = !0),
                    ...
                    (t.scrollbarXWidth = F(
                      t,
                      W((t.railXWidth * t.containerWidth) / t.contentWidth)
                    )),
                    (t.scrollbarXLeft = W(
                ...
                t.containerHeight + t.settings.scrollYMarginOffset <
                  ...
                  ? ((t.scrollbarYActive = !0),
                    ...
                    (t.scrollbarYHeight = F(
                      t,
                      W((t.railYHeight * t.containerHeight) / t.contentHeight)
                    )),
                    (t.scrollbarYTop = W(
          ...
          function V(n, t) {
            ...
            function b() {
              T(n, u),
                n[f].classList.remove(A.state.clicking),
              ...
              (h = d[c]),
                ...
                e
                  ...
                  : (n.event.bind(n.ownerDocument, "mousemove", g),
                    n.event.once(n.ownerDocument, "mouseup", b),
                    t.preventDefault()),
                n[f].classList.add(A.state.clicking),
                t.stopPropagation();
            }
            n.event.bind(n[s], "mousedown", function (t) {
              m(t);
            }),
              n.event.bind(n[s], "touchstart", function (t) {
                m(t, !0);
              });
          }
          function $(t, e) {
          ...
          var q,
              ...
              keyboard: function (o) {
                ...
                o.event.bind(o.ownerDocument, "keydown", function (t) {
                  if (
                    ...
                    (x(a, ":hover") ||
                      x(o.scrollbarX, ":focus") ||
                      x(o.scrollbarY, ":focus"))
                  ) {
                    var e,
                    ...
                    if (n) {
                      ...
                      if (
                        x((e = n), "input,[contenteditable]") ||
                        x(e, "select,[contenteditable]") ||
                        x(e, "textarea,[contenteditable]") ||
                        x(e, "button,[contenteditable]")
                      )
                        return;
                    }
                    var r = 0,
                    ...
                    switch (t.which) {
                      ...
                      case 40:
                        ...
                        break;
                      case 32:
                        i = t.shiftKey ? o.containerHeight : -o.containerHeight;
                        break;
                      case 33:
                        i = o.containerHeight;
                        break;
                    ...
                    (o.settings.suppressScrollX && 0 !== r) ||
                      (o.settings.suppressScrollY && 0 !== i) ||
                      ((a.scrollTop -= i),
                      (a.scrollLeft += r),
                      N(o),
                      (function (t, e) {
                        ...
                        if (0 === t) {
                          ...
                          if (
                            (0 === n && 0 < e) ||
                            (n >= o.contentHeight - o.containerHeight && e < 0)
                          )
                        ...
                        if (0 === e) {
                          ...
                          if (
                            (0 === r && t < 0) ||
                            (r >= o.contentWidth - o.containerWidth && 0 < t)
                          )
                            return !o.settings.wheelPropagation;
                        }
                        return 1;
              ...
              wheel: function (v) {
                ...
                function t(t) {
                  var e,
                    ...
                    p = d[1];
                  !(function (t, e, n) {
                    if (!H.isWebKit && g.querySelector("select:focus"))
                      return 1;
                    if (g.contains(t))
                      for (var r = t; r && r !== g; ) {
                        if (r.classList.contains(A.element.consuming)) return 1;
                        var i = m(r);
                    ...
                    v.settings.useBothWheelAxes
                      ? v.scrollbarYActive && !v.scrollbarXActive
                        ? (p
                            ? (g.scrollTop -= p * v.settings.wheelSpeed)
                            : (g.scrollTop += h * v.settings.wheelSpeed),
                          (i = !0))
                        : v.scrollbarXActive &&
                          !v.scrollbarYActive &&
                          (h
                            ? (g.scrollLeft += h * v.settings.wheelSpeed)
                            : (g.scrollLeft -= p * v.settings.wheelSpeed),
                          (i = !0))
                      : ((g.scrollTop -= p * v.settings.wheelSpeed),
                        (g.scrollLeft += h * v.settings.wheelSpeed)),
                    N(v),
                    (i =
                      ...
                      ((o = h),
                      (a = p),
                      (s = Math.floor(g.scrollTop)),
                      (l = 0 === g.scrollTop),
                      (c = s + g.offsetHeight === g.scrollHeight),
                      (u = 0 === g.scrollLeft),
                      (f = g.scrollLeft + g.offsetWidth === g.scrollWidth),
                      !(Math.abs(a) > Math.abs(o) ? l || c : u || f) ||
                        !v.settings.wheelPropagation)) &&
                      !t.ctrlKey &&
                      (t.stopPropagation(), t.preventDefault()));
                }
                void 0 !== window.onwheel
                  ? v.event.bind(g, "wheel", t)
                  : void 0 !== window.onmousewheel &&
                    v.event.bind(g, "mousewheel", t);
              },
              touch: function (s) {
                var l, c, u, f, n;
                function d(t, e) {
                  (l.scrollTop -= e), (l.scrollLeft -= t), N(s);
                }
                function h(t) {
                  ...
                  if (p(t)) {
                    ...
                    if (
                      (function (t, e, n) {
                        if (l.contains(t))
                          for (var r = t; r && r !== l; ) {
                            if (r.classList.contains(A.element.consuming))
                              return 1;
                            var i = m(r);
                            if (n && i.overflowY.match(/(scroll|auto)/)) {
                              var o = r.scrollHeight - r.clientHeight;
                      ...
                      (function (t, e) {
                        ...
                        if (i < o) {
                          if (
                            ...
                            return 0 === window.scrollY && 0 < e && H.isChrome;
                        } else if (
                          o < i &&
                          ((t < 0 && r === s.contentWidth - s.containerWidth) ||
                            (0 < t && 0 === r))
                        )
                          return 1;
                        return 1;
                  ...
                  s.settings.swipeEasing &&
                    ...
                    (n = setInterval(function () {
                      ...
                      (Math.abs(f.x) < 0.01 && Math.abs(f.y) < 0.01)
                        ? clearInterval(n)
                        : (d(30 * f.x, 30 * f.y), (f.x *= 0.8), (f.y *= 0.8));
                    }, 10)));
                }
                (H.supportsTouch || H.supportsIePointer) &&
                  ((l = s.element),
                  (c = {}),
                  (u = 0),
                  (f = {}),
                  (n = null),
                  H.supportsTouch
                    ? (s.event.bind(l, "touchstart", t),
                      s.event.bind(l, "touchmove", e),
                      s.event.bind(l, "touchend", r))
                    : H.supportsIePointer &&
                      (window.PointerEvent
                        ? (s.event.bind(l, "pointerdown", t),
                          s.event.bind(l, "pointermove", e),
                          s.event.bind(l, "pointerup", r))
                        : window.MSPointerEvent &&
                          (s.event.bind(l, "MSPointerDown", t),
                          s.event.bind(l, "MSPointerMove", e),
                          s.event.bind(l, "MSPointerUp", r))));
              },
            },
            Z = (function () {
              function d(t) {
                ...
                for (var r in ((this.element = t).classList.add(A.main),
                (this.settings = J()),
                n))
                  this.settings[r] = n[r];
                ...
                (this.isRtl = "rtl" === m(t).direction),
                  !0 === this.isRtl && t.classList.add(A.rtl),
                  ...
                  (this.scrollbarXRail = _(A.element.rail("x"))),
                  t.appendChild(this.scrollbarXRail),
                  (this.scrollbarX = _(A.element.thumb("x"))),
                ...
                (this.scrollbarXBottom = parseInt(l.bottom, 10)),
                  isNaN(this.scrollbarXBottom)
                    ? ((this.isScrollbarXUsingBottom = !1),
                      (this.scrollbarXTop = W(l.top)))
                    : (this.isScrollbarXUsingBottom = !0),
                  (this.railBorderXWidth =
                    W(l.borderLeftWidth) + W(l.borderRightWidth)),
                  y(this.scrollbarXRail, { display: "block" }),
                  (this.railXMarginWidth = W(l.marginLeft) + W(l.marginRight)),
                  y(this.scrollbarXRail, { display: "" }),
                  (this.railXWidth = null),
                  (this.railXRatio = null),
                  (this.scrollbarYRail = _(A.element.rail("y"))),
                  t.appendChild(this.scrollbarYRail),
                  (this.scrollbarY = _(A.element.thumb("y"))),
                ...
                var c,
                  u,
                  f = m(this.scrollbarYRail);
                (this.scrollbarYRight = parseInt(f.right, 10)),
                  isNaN(this.scrollbarYRight)
                    ? ((this.isScrollbarYUsingRight = !1),
                      (this.scrollbarYLeft = W(f.left)))
                  ...
                  (this.scrollbarYOuterWidth = this.isRtl
                    ? ((c = this.scrollbarY),
                      W((u = m(c)).width) +
                        ...
                        W(u.paddingRight) +
                        W(u.borderLeftWidth) +
                        W(u.borderRightWidth))
                    : null),
                  (this.railBorderYWidth =
                    W(f.borderTopWidth) + W(f.borderBottomWidth)),
                  y(this.scrollbarYRail, { display: "block" }),
                  (this.railYMarginHeight = W(f.marginTop) + W(f.marginBottom)),
                  y(this.scrollbarYRail, { display: "" }),
                    ...
                    value: function () {
                      this.isAlive &&
                        ...
                        (this.railXMarginWidth =
                          W(m(this.scrollbarXRail).marginLeft) +
                          W(m(this.scrollbarXRail).marginRight)),
                        (this.railYMarginHeight =
                          W(m(this.scrollbarYRail).marginTop) +
                          W(m(this.scrollbarYRail).marginBottom)),
                        y(this.scrollbarXRail, { display: "none" }),
                        y(this.scrollbarYRail, { display: "none" }),
                        N(this),
                        X(this, "top", 0, !1, !0),
                        X(this, "left", 0, !1, !0),
                        y(this.scrollbarXRail, { display: "" }),
            ...
            tt =
              ...
              {
                set: function (t, e, n) {
                  void 0 === t[e] && ((t[e] = { key: e, id: z }), z++),
                    (q[t[e].id] = n);
                },
                get: function (t, e) {
                  if (!t || void 0 === t[e]) return null;
                  var n = t[e];
                  return n.key === e ? q[n.id] : null;
                },
                delete: function (t, e) {
                  var n;
                  void 0 === t[e] ||
                    ((n = t[e]).key === e && (delete q[n.id], delete t[e]));
                },
              }),
            et = {
          ...
          function pt(t, e, n) {
            for (
              ...
              var s = t[i[o]];
              if (s.originalHandler === e && s.delegationSelector === r)
                return s;
            }
            return null;
          }
          function vt(t, e, n) {
            var r = "string" == typeof e,
              ...
              o = t.replace(at, ""),
              a = ut[o];
            return a && (o = a), -1 < ft.indexOf(o) || (o = t), [r, i, o];
          }
          function gt(t, e, n, r, i) {
            var o, a, s, l, c, u, f, d, h, p, v, g, b, m;
            "string" == typeof e &&
              t &&
              (n || ((n = r), (r = null)),
              (a = (o = nt(vt(e, n, r), 3))[0]),
              (s = o[1]),
              (l = o[2]),
              (f = pt((u = (c = ht(t))[l] || (c[l] = {})), s, a ? n : null))
                ? (f.oneOff = f.oneOff && i)
                : ((d = dt(s, e.replace(ot, ""))),
                  ((h = a
                    ? ((g = t),
                      ...
                      function t(e) {
                        for (
                          var n = g.querySelectorAll(b), r = e.target;
                          r && r !== this;
                          r = r.parentNode
                        )
                    ...
                    : ((p = t),
                      ...
                      function t(e) {
                        return (
                          t.oneOff && mt.off(p, e.type, v), v.apply(p, [e])
                        );
          ...
          var Et = {
              setDataAttribute: function (t, e, n) {
                t.setAttribute("data-mdb-".concat(St(e)), n);
              },
              removeDataAttribute: function (t, e) {
                t.removeAttribute("data-mdb-".concat(St(e)));
              },
              ...
              getDataAttribute: function (t, e) {
                return xt(t.getAttribute("data-mdb-".concat(St(e))));
              },
              offset: function (t) {
            ...
            Ot = function (t, e, n) {
              ...
              return '\n<div class="table-editor__pagination">\n  <div class="table-editor__select-wrapper">\n    <p class="table-editor__select-text">'
                ...
                .concat(
                  a
                    ? '<button data-mdb-ripple-color="'.concat(
                        n ? "light" : "dark",
              ...
              i = e.map(function (n, r) {
                ...
                return '<th style="'
                  .concat(
                    n.fixed
                      ? ""
                          .concat("right" === n.fixed ? "right" : "left", ": ")
                          .concat(t, "px;")
                      : "",
                    '" '
                  )
                  .concat(n.fixed ? 'class="fixed-cell"' : "", ' scope="col">')
                  .concat(
                    n.sort
                      ? '<i data-mdb-sort="'.concat(
                          n.field,
                          '" class="table-editor__sort-icon fas fa-arrow-up"></i>'
                        )
                      : "",
                    " "
                  )
          ...
          function Rt(t, e, n) {
            var r,
              i = ((r = "div"), document.createElement(r));
            return (
              Et.addClass(i, "modal"),
              Et.addClass(i, "fade"),
              (i.innerHTML =
                '\n  <div class="modal-dialog">\n    <div class="modal-content '
                  ...
                  .concat(
                    n ? "light" : "primary",
                    ' modal-discard-button" data-mdb-dismiss="modal">'
                  )
                  .concat(
                    e,
          ...
          var Lt = function (t) {
              ...
              return '<div class="form-check ms-1 mt-1 ps-0">\n<input\n  '
                ...
                .concat(
                  o
                    ? '<label class="ps-3 form-check-label">'.concat(
                        i,
                        "</label>"
                      )
                    : "",
            ...
            It = function (t) {
              ...
              return "<select "
                ...
                .concat(
                  s
                    ? '<label class="form-label select-label">'.concat(
                        a,
                        "</label>"
                      )
                    : ""
            ...
            Mt = function (t) {
              ...
              return '<div class="form-outline '
                .concat(l ? "form-white" : "", '"><input ')
                .concat(o ? "" : "disabled", ' type="')
                .concat(i, '"class="table-editor__input form-control" value="')
                .concat(e[n], '">\n  ')
                .concat(
                  s ? '<label class="form-label">'.concat(a, "</label>") : "",
                  "\n  </div>"
                );
            },
            Ct = function (t) {
              ...
              var l = Pt(
                Pt({ row: e }, n),
                {},
                { edited: r, showLabel: o, darkMode: s }
              );
              switch (n.inputType) {
                case "checkbox":
                  return Lt(l);
                      ...
                      .map(function (t, e) {
                        var n,
                          ...
                          l =
                            ...
                            (a = {}),
                            (n = t).width &&
                              ((a["min-width"] = "".concat(n.width, "px")),
                              (a["max-width"] = "".concat(n.width, "px"))),
                            n.fixed &&
                              ((o = i
                                .filter(function (t, e) {
                                  return t.fixed === n.fixed && e < r;
                          ...
                          c =
                            ...
                            Object.keys(s)
                              ...
                              .join("; ")),
                          u = Ct({ row: f, column: t, edited: d, darkMode: p });
                        return '<td style="'
                          .concat(c, '" class="')
                          .concat(
                            t.fixed ? "fixed-cell" : "",
          ...
          function Ht(t, e, n) {
            ...
            return t.filter(function (e) {
              if (n && "string" == typeof n) return r(e[n]);
            ...
            return t.map(function (t, e) {
              var n,
                ...
                i = Wt(
                  Wt({}, a),
                  {},
                  { field: "field_".concat(e), columnIndex: e }
                ),
                o =
                  ((r = i),
                  "string" == typeof (n = t)
              ...
              return (
                o.options &&
                  "string" == typeof o.options &&
                  (o.options = JSON.parse(o.options.replace(/'/g, '"'))),
                null !== o.defaultValue &&
                  (o.defaultValue = o.defaultValue.toString()),
                s && l("column", o, s),
                o
              );
            });
              ...
              if (Array.isArray(r)) {
                ...
                return (
                  e.forEach(function (t, e) {
                    var n = r[e];
                    ("number" !== t.inputType && "checkbox" !== t.inputType) ||
                      (n = JSON.parse(n)),
                      (i[t.field] = n);
                  }),
                  i
          ...
          function Ut(t) {
            var e = v.closest(t, "tr");
            return Et.getDataAttribute(e, "index");
          }
          function Vt(t) {
            return (Vt =
          ...
          function Jt(i) {
            for (var t = 1; t < arguments.length; t++) {
              var o = null != arguments[t] ? arguments[t] : {};
              t % 2
                ? zt(Object(o), !0).forEach(function (t) {
                    var e, n, r;
                    (e = i),
                      (r = o[(n = t)]),
                      n in e
                ...
                : zt(Object(o)).forEach(function (t) {
                    Object.defineProperty(
                      i,
                      t,
                      Object.getOwnPropertyDescriptor(o, t)
          ...
          var Zt,
            ...
            ne = "edited-table",
            re = "table-editor",
            ie = "[data-mdb-add-entry]",
            oe = ".table-editor__input-select",
            ae = "[data-mdb-search]",
            se = ".table-editor__sort-icon",
            le = "render.mdb.tableEditor",
            ce = {
              columnIndex: 0,
              defaultValue: null,
              editable: !0,
            ...
            he = (function () {
              function o(t) {
                ...
                !(function (t, e) {
                  ...
                  (this._addBtn = this._getDOMElement(ie)),
                ...
                (n = [
                  {
                    ...
                    value: function (n, r, i) {
                      return this.each(function () {
                        var t = et.getData(this, ee),
                          e = "object" === Vt(n) && n;
                        if (
                          (t || !/dispose/.test(n)) &&
                          ((t = t || new o(this, e, r)), "string" == typeof n)
                        ) {
                          if (void 0 === t[n])
                            throw new TypeError(
                ...
                (e = [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      clearTimeout(this._timeout),
                        ...
                        et.removeData(this._element, ee),
                  ...
                  },
                  {
                    ...
                    value: function (t, e) {
                      ...
                      t && t.rows && (this._rows = t.rows),
                        ...
                        this._clearClassList(n),
                        (this._options = this._getOptions(
                          Jt(Jt({}, this._options), n)
                        )),
                        this._setup();
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      this._options.color &&
                        e.color &&
                        Et.removeClass(this._element, this._options.color),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (this._modal = Rt(
                        this._options.saveText,
                        this._options.cancelText,
                        this._options.dark
                      )),
                        this._element.appendChild(this._modal),
                        (this._modalInstance = new mdb.Modal(this._modal, {
                          backdrop: "static",
                          keyboard: !1,
                        })),
                  ...
                  },
                  {
                    ...
                    value: function (n) {
                      ...
                      e.defaultPrevented
                        ? e.preventDefault()
                        : ((this._rows = this._rows.filter(function (t, e) {
                            return e !== n;
                          })),
                          this._renderRows(),
                          this._refreshPagination(),
                          this._triggerUpdate(t, "delete"));
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      (this._editMode = !0),
                        ...
                        (this._tempRow =
                          this._newRow ||
                          Jt({}, this._rows[this._selectedIndex])),
                        this._disableDOMElements(),
                        this._renderRows(),
                        this._setEditClassName(),
                        this._inline ||
                          (this._setModalBody(), this._modalInstance.show()),
                        this._setInputs(),
                        this._setFocusTrap();
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      (this._selectedIndex = null),
                        ...
                        (this._newRow = null),
                        this._renderRows(),
                        Et.removeClass(this._element, ne),
                        this._enableDOMElements(),
                        this._inline || this._modalInstance.hide(),
                        yt.trigger(this._element, "exit.mdb.tableEditor");
                    },
                  },
                  {
                    key: "_getColumns",
                    value: function (t) {
                      var e = 0 < arguments.length && void 0 !== t ? t : [],
                        n = v.findOne("thead", this._element);
                      if (!n) return Nt(e, ce, ue);
                      var r = v.findOne("tr", n),
                        i = v.find("th", r).map(function (t) {
                          return Jt(
                            { label: t.innerHTML },
                            Et.getDataAttributes(t)
                          );
                        });
                      return Nt([].concat(Kt(i), Kt(e)), ce, ue);
                    },
                  },
                  {
                    key: "_getDOMElement",
                    value: function (t) {
                      var n = this;
                      return v.find(t).find(function (t) {
                        var e = Et.getDataAttribute(t, "target");
                        return v.findOne(e) === n._element;
                      });
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      var e = Jt(
                        Jt(Jt({}, fe), Et.getDataAttributes(this._element)),
                        t
                      );
                      return (
                        "string" == typeof e.entriesOptions &&
                          (e.entriesOptions = JSON.parse(e.entriesOptions)),
                        l(te, e, de),
                        e
                      );
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      var e = 0 < arguments.length && void 0 !== t ? t : [],
                        n = v.findOne("tbody", this._element);
                      if (!n) return Ft(e, this._columns);
                      var r = v.find("tr", n).map(function (t) {
                        return v.find("td", t).map(function (t) {
                          return t.innerHTML;
                        });
                      });
                      return Ft([].concat(Kt(r), Kt(e)), this._columns);
                    },
                  },
                  {
                    key: "_renderTable",
                    value: function () {
                      (this._element.innerHTML = Dt(this.tableOptions).table),
                        yt.trigger(this._element, le),
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (this._newRow) {
                        ...
                        if (n.defaultPrevented) return void n.preventDefault();
                        (e = "add"), this._rows.push(t);
                      } else {
                        var r = yt.trigger(
                          this._element,
                        ...
                        if (r.defaultPrevented) return void r.preventDefault();
                        (e = "edit"), (this._rows[this._selectedIndex] = t);
                      }
                      this._triggerUpdate(t, e), this._exitEditMode();
                    },
                  },
                  {
                    ...
                    value: function () {
                      this._editMode &&
                        this._inline &&
                        (Et.addClass(this.selectedRow, "edited-row"),
                        Et.addClass(this._element, ne));
                    },
                  },
                  {
                    key: "_setClassNames",
                    value: function () {
                      var e = this;
                      this.classNames.forEach(function (t) {
                        Et.addClass(e._element, t);
                      });
                    },
                  },
                  {
                    ...
                    value: function (n) {
                      var r = this;
                      v.find(se, this._element).forEach(function (t) {
                        var e = "desc" === r._sortOrder && t === n ? 180 : 0;
                        Et.style(t, { transform: "rotate(".concat(e, "deg)") }),
                          t === n && r._sortOrder
                            ? Et.addClass(t, "active")
                            : Et.removeClass(t, "active");
                      });
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var e = this,
                        t = this._inline ? 0 : 200;
                      this._timeout = setTimeout(function () {
                        (e._focusTrap = new b(e.editElement)),
                          e._focusTrap.trap();
                        var t = v.findOne("input", e.editElement);
                        t && t.focus();
                      }, t);
                    },
                  },
                  {
                    ...
                    value: function () {
                      var e = this;
                      v
                        .find(".form-outline", this._element)
                        .forEach(function (t) {
                          new mdb.Input(t).init();
                        }),
                        v.find(oe, this._element).forEach(function (t) {
                          new mdb.Select(t);
                        }),
                        v.find("input", this.editElement).forEach(function (t) {
                          t.addEventListener("input", function (t) {
                            return e._updateValue(t);
                          });
                        }),
                        v.find(oe, this.editElement).forEach(function (t) {
                          t.addEventListener(
                    ...
                    value: function () {
                      var e,
                        ...
                        o =
                          ...
                          (i = t
                            .map(function (t) {
                              return '\n      <div class="my-4 table-editor_input-wrapper" data-mdb-field="'
                                .concat(t.field, '">')
                                .concat(
                                  Ct({
                                    row: e,
                      ...
                      (v.findOne(".modal-body", this._modal).innerHTML =
                        o.body),
                        (v.findOne(".modal-header", this._modal).innerHTML =
                          o.header);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var t = this;
                      yt.on(
                        v.findOne(".modal-save-button", this.editElement),
                        "click",
                        function () {
                        ...
                        yt.on(
                          v.findOne(".modal-discard-button", this.editElement),
                          "click",
                          function () {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      this._editMode
                        ? (yt.on(
                            v.findOne(".save-button", this.editElement),
                            "click",
                            function () {
                              return e._saveChanges();
                            }
                          ),
                          yt.on(
                            v.findOne(".discard-button", this.editElement),
                            "click",
                            function () {
                              return e._exitEditMode();
                            }
                          ))
                        : (v
                            .find(".edit-button", this._element)
                            .forEach(function (t) {
                              t.addEventListener("click", function () {
                                return e._editRow(Ut(t));
                              });
                            }),
                          v
                            .find(".delete-button", this._element)
                            .forEach(function (t) {
                              t.addEventListener("click", function () {
                                e._deleteRow(Ut(t));
                              });
                          ...
                          this._options.confirm &&
                            (this._popconfirmInstances = v
                              .find(".popconfirm-toggle", this._element)
                              .map(function (t) {
                                return (
                                  t.addEventListener(
                                    "confirm.mdb.popconfirm",
                                    function () {
                                      return e._deleteRow(Ut(t));
                                    }
                                  ),
                                  new mdb.Popconfirm(t, {
                                    message: e._options.confirmMessage,
                                    cancelText: e._options.cancelText,
                                    okText: e._options.confirmText,
                                  })
                                );
                              })));
                    },
                  },
                  {
                    ...
                    value: function () {
                      var t,
                        e = this,
                        n = v.findOne(".table-editor__inner", this._element),
                        r = { overflow: "auto", position: "relative" };
                      this._options.maxHeight &&
                        (r.maxHeight = Bt(this._options.maxHeight)),
                        this._options.maxWidth &&
                          ((t = Bt(this._options.maxWidth)),
                          (r.maxWidth = t),
                          Et.style(this._element, { maxWidth: t })),
                        Et.style(n, r),
                        this._options.fixedHeader &&
                          v.find("th", this._element).forEach(function (t) {
                            Et.addClass(t, "fixed-cell"),
                              Et.addClass(t, e._options.color);
                          }),
                        (this._perfectScrollbar = new Z(n));
                    },
                  },
                  {
                    key: "_updateValue",
                    value: function (t) {
                      var e =
                          v.closest(t.target, "td") ||
                          v.closest(t.target, ".table-editor_input-wrapper"),
                        n = Et.getDataAttribute(e, "field"),
                        r =
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var r = this;
                      v.find(se, this._element).forEach(function (t) {
                        var e = Et.getDataAttribute(t, "sort"),
                          n = $t(v.parents(t, "th"), 1)[0];
                        Et.style(n, { cursor: "pointer" }),
                          yt.on(n, "click", function () {
                            r._sortField === e && "asc" === r._sortOrder
                              ? (r._sortOrder = "desc")
                              : r._sortField === e && "desc" === r._sortOrder
                              ? (r._sortOrder = null)
                              : (r._sortOrder = "asc"),
                              (r._sortField = e),
                              (r._activePage = 0),
                              r._toggleDisableState(),
                              r._renderRows(),
                              r._setActiveSortIcon(t);
                          });
                      });
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      (this._paginationRight = v.findOne(
                        ".table-editor__pagination-right",
                        this._element
                      )),
                        (this._paginationLeft = v.findOne(
                          ".table-editor__pagination-left",
                          this._element
                        )),
                        this._setupPaginationSelect(),
                        yt.on(this._paginationRight, "click", function () {
                          return t._changeActivePage(t._activePage + 1);
                        }),
                        yt.on(this._paginationLeft, "click", function () {
                          return t._changeActivePage(t._activePage - 1);
                        }),
                        this._options.fullPagination &&
                          ((this._paginationStart = v.findOne(
                            ".table-editor__pagination-start",
                            this._element
                          )),
                          (this._paginationEnd = v.findOne(
                            ".table-editor__pagination-end",
                            this._element
                          )),
                          yt.on(this._paginationStart, "click", function () {
                            return t._changeActivePage(0);
                          }),
                          yt.on(this._paginationEnd, "click", function () {
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this._options.pagination &&
                        (yt.off(this._paginationRight, "click"),
                        yt.off(this._paginationLeft, "click"),
                        yt.off(this._select, "valueChange.mdb.select"),
                        this._options.fullPagination &&
                          (yt.off(this._paginationStart, "click"),
                          yt.off(this._paginationEnd, "click"))),
                        v.find(se, this._element).forEach(function (t) {
                          var e = $t(v.parents(t, "th"), 1)[0];
                          yt.off(e, "click");
                        });
                    },
                  },
                  ...
                  },
                  {
                    key: "_renderRows",
                    value: function () {
                      var t = v.findOne("tbody", this._element);
                      this._options.pagination &&
                        (v.findOne(
                          ".table-editor__pagination-nav",
                          this._element
                        ).innerText = this.navigationText),
                        (t.innerHTML = Dt(this.tableOptions).rows),
                        yt.trigger(this._element, le),
                        this._setupActionButtons();
                    },
                  },
                    ...
                    value: function () {
                      0 === this._activePage || this._options.loading
                        ? (this._paginationLeft.setAttribute("disabled", !0),
                          this._options.fullPagination &&
                            this._paginationStart.setAttribute("disabled", !0))
                  ...
                  },
                  {
                    key: "_triggerUpdate",
                    value: function (t, e) {
                      yt.trigger(this._element, "update.mdb.tableEditor", {
                        row: t,
                        action: e,
                      });
                    },
                  },
                  {
                    ...
                    get: function () {
                      var r = this;
                      return this._rows.map(function (e, t) {
                        var n = { rowIndex: t };
                        return (
                          r._columns.forEach(function (t) {
                            n[t.field] =
                              null === e[t.field]
                                ? t.defaultValue || r._options.defaultValue
                                : e[t.field];
                          }),
                          n
                        );
                  ...
                  },
                  {
                    key: "searchResult",
                    get: function () {
                      return Ht(this.rows, this._search, this._searchColumn);
                    },
                  },
                  {
                    key: "emptyRow",
                    get: function () {
                      ...
                      return (
                        this._columns.forEach(function (t) {
                          n[t.field] =
                            t.defaultValue || e._options.defaultValue;
                        }),
                        n
                      );
                    },
                    ...
                    get: function () {
                      ...
                      return (
                        ...
                        this._options.pagination &&
                          ...
                          (s = n.activePage * a),
                          (l = r.slice(s, s + a))),
                        this._newRow && this._inline
                          ? [this._newRow].concat(Kt(l))
                          : l
                      );
                    },
                  },
                  {
                    ...
                    get: function () {
                      return (
                        Math.ceil(
                          this.searchResult.length / this._options.entries
                        ) || 1
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    get: function () {
                      return v.findOne(
                        'tr[data-mdb-index="'.concat(this._selectedIndex, '"]'),
                        this._element
                      );
                    },
                  },
                  {
                    ...
                    get: function () {
                      return this._inline
                        ? this.selectedRow
                        : v.findOne(".table-editor .modal", this._element);
                    },
                  },
                  {
                    key: "modalHeader",
                    get: function () {
                      return this._newRow
                        ? this._options.newItemHeader
                        : this._options.editItemHeader;
                    },
                  },
                  {
                    key: "classNames",
          ...
          v.find(".table-editor").forEach(function (t) {
            return he.getInstance(t) || new he(t);
          }),
            v.find(ie).forEach(function (n) {
              n.addEventListener("click", function () {
                var t = Et.getDataAttribute(n, "target"),
                  e = he.getInstance(v.findOne(t));
                e && e.add();
              });
            }),
            v.find(ae).forEach(function (r) {
              r.addEventListener("input", function (t) {
                var e = Et.getDataAttribute(r, "target"),
                  n = he.getInstance(v.findOne(e));
                n && n.search(t.target.value);
              });
            }),
            (Zt = function () {
              var t,
              ...
              e &&
                ((t = e.fn[te]),
                (e.fn[te] = he.jQueryInterface),
                (e.fn[te].Constructor = he),
                (e.fn[te].noConflict = function () {
                  return (e.fn[te] = t), he.jQueryInterface;
                }));
            }),
