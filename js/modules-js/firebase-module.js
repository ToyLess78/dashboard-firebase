...
export {app, db, get, ref, firstData, set, child, push, remove, Firebase, customerBase, customerStorage, teamBase, teamStorage, priceBase, exampleBase, priceStorage, mainAnalyticsBase, invoiceBase, doubleBase}
...
const doubleBase = new Firebase('double/')
